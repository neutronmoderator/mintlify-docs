---
title: Boundless Proving Stack
description: A high-level explainer on the individual parts that make up the Boundless proving stack.
icon: cubes-stacked
---
...
![Bento Diagram](/images/bento.png)
...
<Frame caption="Figure 1: Proof Lifecycle of a Boundless Proof.">
  <img src="/images/proof-lifecycle.png" alt="Proof Lifecycle Diagram" />
</Frame>
...
![A diagram showing how Bento & Broker are related](/images/bento_broker.png)
