---
title: Wallet Setup
description: Best practices for wallets used in Staking, Proving and ZK Mining.
icon: wallet
---
...
![Reward Claim Flow](/images/reward_claim_flow.png)
...
![Wallet Setup Recommendations](/images/boundless_wallet_setup.png)
