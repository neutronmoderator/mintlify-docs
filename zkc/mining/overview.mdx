...
#### Provers aggregate work proofs with `prepare-mining`
...
#### Provers submit the aggregated work proof with `submit-mining`
...
#### Provers claim rewards with `claim-mining-rewards`
