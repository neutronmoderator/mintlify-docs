...
- To use *\$ZKC* in the Boundless market as [Proving Collateral](/provers/quick-start#deposit-collateral) on Base mainnet, *\$ZKC* must be [bridged](/zkc/collateral#bridging-zkc) from Ethereum mainnet to Base mainnet.
</Note>
