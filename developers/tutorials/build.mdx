...
description: Learn how to build a guest program
icon: hammer
---

import { StripRustCodeComments } from "/snippets/strip-rust-code-comments.jsx"
...
![Boundless Foundry Template](/images/boundless-foundry-template.png)
