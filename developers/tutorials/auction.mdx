---
title: Set up the Auction
description: Configuring auction parameters for a proof request.
icon: gavel
---

import { TimeCalculator } from '/snippets/time-calculator.jsx';
...
![Offer Parameter Diagram](/images/request_diagram.png)
...
| Parameter     | Units | Recommendation | Notes |
|---------------|-------|----------------|-------|
| Minimum Price | wei   | For testing purposes, set the minimum price to 0 (as of October 2025)). To guarantee the lowest latency in both locking and fulfillment, it is recommended to set the minimum price as non-zero.    | As market demand and supply normalizes, competition will stabilize prices at non-zero.|
