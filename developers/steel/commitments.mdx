---
title: Steel Commitments
description: A guide to how Steel Commitments work.
icon: anchor-lock
---
...
Crucially, during the step, Steel will use the RPC call [eth_getProof](https://docs.alchemy.com/reference/eth-getproof) for all accounts accessed during the preflight and the return data is combined into a sparse Merkle trie.
